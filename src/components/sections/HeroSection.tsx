      ...
      <div className="container max-w-6xl mx-auto relative z-10 my-0 mt-[82px]">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            >
              Escuela-club de gimnasia artística y rítmica
            </motion.p>
          ...
          >
            ...
            <div className="relative">
              ...
              >
                <img
                  src={heroImage2}
                  alt="Alumnas de Evolut entrenando"
                  className="w-full h-auto rounded-xl shadow-xl object-cover aspect-square border-4 border-background"
                />
              </motion.div>
            </div>
          </motion.div>
